  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <>
          <div className="max-w-[1300px] mx-auto flex justify-center mt-[30px]">
            <div className="grid justify-center gap-4 mx-auto md:grid-cols-3 items center">
              {data.map((val, i) => (
                <div
                  key={i}
                  className="h-[360px] w-[420px] rounded-2xl border-1 border-gray-400 p-3"
                >
                  <img
                    className="rounded-xl h-[220px] w-[380px] object-cover mx-auto"
                    src={
                      val === null || val.Avatar === undefined
                        ? "/images/NFT.png"
                        : val.Avatar
                    }
                    alt=""
                  />
                  <p className="px-2 mt-3 text-xl text-black text-bold">
                    {val.name}
                  </p>
                  <div className="p-2 mt-2 rounded-2xl">
                    <div className="flex">
                      ...
                      <p className="flex items-center px-3">
                        {val.user[0].attributes.username}
                      </p>
                    </div>
                  </div>
                </div>
